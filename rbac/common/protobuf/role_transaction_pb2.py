...
_AUTOADDROLEMEMBER_METADATAENTRY = _descriptor.Descriptor(
  name='MetadataEntry',
  full_name='AutoAddRoleMember.MetadataEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='AutoAddRoleMember.MetadataEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='AutoAddRoleMember.MetadataEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AUTOADDROLEMEMBER = _descriptor.Descriptor(
  name='AutoAddRoleMember',
  full_name='AutoAddRoleMember',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='proposal_id', full_name='AutoAddRoleMember.proposal_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='object_id', full_name='AutoAddRoleMember.object_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='related_id', full_name='AutoAddRoleMember.related_id', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='open_reason', full_name='AutoAddRoleMember.open_reason', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='AutoAddRoleMember.metadata', index=4,
      number=5, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pack_id', full_name='AutoAddRoleMember.pack_id', index=5,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='assigned_approver', full_name='AutoAddRoleMember.assigned_approver', index=6,
      number=7, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='close_reason', full_name='AutoAddRoleMember.close_reason', index=7,
  ...
  nested_types=[_AUTOADDROLEMEMBER_METADATAENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_AUTOADDROLEMEMBER_METADATAENTRY.containing_type = _AUTOADDROLEMEMBER
_AUTOADDROLEMEMBER.fields_by_name['metadata'].message_type = _AUTOADDROLEMEMBER_METADATAENTRY
...
DESCRIPTOR.message_types_by_name['AutoAddRoleMember'] = _AUTOADDROLEMEMBER
...
AutoAddRoleMember = _reflection.GeneratedProtocolMessageType('AutoAddRoleMember', (_message.Message,), dict(

  MetadataEntry = _reflection.GeneratedProtocolMessageType('MetadataEntry', (_message.Message,), dict(
    DESCRIPTOR = _AUTOADDROLEMEMBER_METADATAENTRY,
    __module__ = 'role_transaction_pb2'
    # @@protoc_insertion_point(class_scope:AutoAddRoleMember.MetadataEntry)
    ))
  ,
  DESCRIPTOR = _AUTOADDROLEMEMBER,
  __module__ = 'role_transaction_pb2'
  # @@protoc_insertion_point(class_scope:AutoAddRoleMember)
  ))
_sym_db.RegisterMessage(AutoAddRoleMember)
_sym_db.RegisterMessage(AutoAddRoleMember.MetadataEntry)
...
_AUTOADDROLEMEMBER_METADATAENTRY._options = None
